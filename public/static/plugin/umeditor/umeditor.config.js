...
UMEDITOR_HOME_URL = '/static/plugin/umeditor/';
(function () {
  /**
  ...
  window.UMEDITOR_CONFIG = {
    ...
    //图片上传配置区
    ,imageUrl:"/admin/index/richTextUpload"             //图片上传提交地址
    ...
    ,toolbar:[
      'source | selectall cleardoc | undo redo | bold italic underline strikethrough | superscript subscript | forecolor backcolor | removeformat |',
